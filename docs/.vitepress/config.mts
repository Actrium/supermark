...
export default defineConfig({
  ...
  base: '/supramark/',
  srcExclude: ['guide/design-system.md'],
  ...
  themeConfig: {
    nav: [
      ...
      { text: 'Architecture', link: '/architecture/DOCUMENTATION_ARCHITECTURE' },
      ...
      '/guide/': [
        {
          ...
          items: [
            ...
            { text: 'Custom Features', link: '/guide/custom-features' },
            { text: 'Feature Creation Guide', link: '/guide/CREATE_FEATURE_GUIDE' },
            { text: 'Feature Quality Assurance', link: '/guide/FEATURE_QUALITY_ASSURANCE' },
            { text: 'CI Setup', link: '/guide/CI_SETUP' },
            { text: 'Documentation System', link: '/guide/doc-system' },
          ],
        },
      ],
      '/architecture/': [
        {
          text: 'Architecture',
          items: [
            { text: 'Documentation Architecture', link: '/architecture/DOCUMENTATION_ARCHITECTURE' },
            { text: 'Plugin System', link: '/architecture/PLUGIN_SYSTEM' },
            { text: 'Engines and CLI Plan', link: '/architecture/ENGINES_AND_CLI_PLAN' },
            { text: 'Diagram Engine Target', link: '/architecture/DIAGRAM_ENGINE_TARGET' },
            { text: 'Diagram Semantic AST', link: '/architecture/diagram-semantic-ast' },
            {
              text: 'Diagram Semantic AST Implementation',
              link: '/architecture/diagram-semantic-ast-impl-plan',
            },
            { text: 'AST Spec', link: '/architecture/ast-spec' },
            { text: 'Dependency Graph', link: '/architecture/dependency-graph' },
            { text: 'License Compatibility', link: '/architecture/LICENSE_COMPATIBILITY' },
            { text: 'Project Structure Report', link: '/architecture/PROJECT_STRUCTURE_REPORT' },
            { text: 'Native FFI Blockers', link: '/architecture/native-ffi-blockers' },
          ],
        },
      ],
      '/features/': [
