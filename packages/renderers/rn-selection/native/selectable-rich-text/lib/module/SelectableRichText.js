...
import FabricSelectableRichText, { Commands as SelectableRichTextCommands } from './NativeSelectableRichTextNativeComponent';
...
const NativeSelectableRichText = Platform.OS === 'ios' || Platform.OS === 'android' ? FabricSelectableRichText : null;
...
const SelectableRichText = /*#__PURE__*/React.forwardRef(({
  selectable = false,
  style,
  children,
  menuItems,
  ...
  React.useImperativeHandle(ref, () => ({
    selectRange: (start, end) => {
      dispatchSelectableRichTextCommand(nativeRef, nativeView => {
        SelectableRichTextCommands[SELECTABLE_RICH_TEXT_COMMANDS.selectRange](nativeView, start, end);
      });
    },
    selectParagraphAt: (x, y) => {
      dispatchSelectableRichTextCommand(nativeRef, nativeView => {
        SelectableRichTextCommands[SELECTABLE_RICH_TEXT_COMMANDS.selectParagraphAt](nativeView, x, y);
      });
    },
    clearSelection: () => {
      dispatchSelectableRichTextCommand(nativeRef, nativeView => {
        SelectableRichTextCommands[SELECTABLE_RICH_TEXT_COMMANDS.clearSelection](nativeView);
      });
    },
    copyRange: (start, end) => {
      dispatchSelectableRichTextCommand(nativeRef, nativeView => {
        SelectableRichTextCommands[SELECTABLE_RICH_TEXT_COMMANDS.copyRange](nativeView, start, end);
      });
    }
  }), []);
  ...
  return /*#__PURE__*/_jsx(NativeSelectableRichText, {
    ref: nativeRef,
    selectable: selectable,
    style: style,
    menuItems: menuItems,
    ...
    children: /*#__PURE__*/_jsx(TextAncestor.Provider, {
      value: true,
      children: children
    })
  });
