      ...
      functions: [
        {
          ...
          description: '创建 Definition List Feature 配置对象，用于在 SupramarkConfig 中启用定义列表支持',
          parameters: [
            {
              name: 'enabled',
              type: 'boolean',
      ...
      types: [
        {
          ...
          description: 'Definition List Feature 配置类型，是 FeatureConfigWithOptions<DefinitionListFeatureOptions> 的类型别名',
          definition: 'type DefinitionListFeatureConfig = FeatureConfigWithOptions<DefinitionListFeatureOptions>',
        },
      ],
    },
    ...
    faq: [
      {
        ...
        answer: '术语单独一行，定义以 :   开头（冒号后至少 3 个空格或 1 个 tab）。例如：Term\\n:   Definition',
      },
      {
        question: '一个术语可以有多个定义吗？',
        answer: '可以。每个定义单独一行并以 :   开头即可，例如：Term\\n:   Definition 1\\n:   Definition 2',
      },
      {
...
export type DefinitionListFeatureConfig =
  FeatureConfigWithOptions<DefinitionListFeatureOptions>;
