      ...
      rn: [
        {
          ...
          input: {
            ...
            start: null,
            children: [
              { type: 'list_item', children: [{ type: 'text', value: '项目1' }] },
            ],
          } as SupramarkNode,
          expected: (output) => output !== null && output !== undefined,
          snapshot: true,
      ...
      functions: [
        {
          ...
          description: '创建 Core Markdown Feature 配置对象，用于在 SupramarkConfig 中启用基础 Markdown 语法支持',
          parameters: [
            {
              name: 'enabled',
              type: 'boolean',
      ...
      types: [
        {
          ...
          description: 'Core Markdown Feature 配置类型，是 FeatureConfigWithOptions<CoreMarkdownFeatureOptions> 的类型别名',
          definition: 'type CoreMarkdownFeatureConfig = FeatureConfigWithOptions<CoreMarkdownFeatureOptions>',
        },
      ],
    },
    ...
    faq: [
      {
        ...
        answer: 'Core Markdown Feature 包含所有基础 Markdown 语法，包括标题、段落、列表、代码块、引用、强调、链接、图片等核心元素。',
      },
      {
        question: 'Core Markdown 与扩展功能有什么区别？',
        answer: 'Core Markdown 提供标准 Markdown 语法支持，扩展功能（如 GFM、Math、Footnote 等）提供额外的语法能力。',
      },
      {
        question: '是否必须启用 Core Markdown Feature？',
        answer: '是的。Core Markdown Feature 提供了基础的 Markdown 解析能力，是其他扩展功能的基础。',
      },
    ],
  },
};
...
export type CoreMarkdownFeatureConfig =
  FeatureConfigWithOptions<CoreMarkdownFeatureOptions>;
