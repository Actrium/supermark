  ...
  renderers: {
    ...
    web: {
      ...
      infrastructure: {
        ...
        clientScriptBuilder: () =>
          '<!-- ECharts scripts provided by @supramark/web-diagram -->',
      },
      dependencies: [
        {
          name: 'echarts',
      ...
      functions: [
        {
          ...
          parameters: [
            ...
            { name: 'options', type: 'DiagramEchartsFeatureOptions', description: '可选配置项', optional: true },
          ],
...
export type DiagramEchartsFeatureConfig =
  FeatureConfigWithOptions<DiagramEchartsFeatureOptions>;
