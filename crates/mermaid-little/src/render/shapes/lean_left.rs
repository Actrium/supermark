...
//!   points = (0, 0), (w + 3h/6, 0), (w, -h), (-3h/6, -h)
...
pub fn draw(node: &Node, _theme: &ThemeVariables) -> Result<String> {
    ...
    let pts = [(0.0, 0.0), (w + shear, 0.0), (w, -h), (-shear, -h)];
...
mod tests {
    ...
    fn lean_left_polygon_matches_upstream() {
        ...
        // shear=20, base_w=60: pts (0,0)(80,0)(60,-40)(-20,-40), transform=(-30,20)
        assert!(got.contains(r#"points="0,0 80,0 60,-40 -20,-40""#));
